...
import hung.entity.Book;
import hung.entity.Category;
import hung.entity.Publisher;
...
//			sessionFactory = config.buildSessionFactory(reg);
			if(sessionFactory == null) {
				...
				MetadataSources metadataSources = new MetadataSources(standardServiceRegistry).addAnnotatedClass(Category.class);
